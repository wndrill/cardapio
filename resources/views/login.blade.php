                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div class=" relative flex items-center justify-center ">
                            <a href="{{ route('redirect', 'google') }}"
                                class=" w-80 group flex flex-row justify-center items-center h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                                <div class="relative flex items-center space-x-4 justify-center">
                                    <img src="https://tailus.io/sources/blocks/social/preview/images/google.svg"
                                        class="relative left-0 w-5" alt="google logo">
                                    <span
                                        class="relative block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Acesse
                                        com Google
                                    </span>
                                </div>
                            </a>
